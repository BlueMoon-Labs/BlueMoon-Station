...
mob/living/proc/ghost_cafe_traits(switch_on = FALSE, additional_area)
	if(switch_on)
		AddElement(/datum/element/ghost_role_eligibility, free_ghosting = TRUE, _role_eligible = FALSE)
		...
		RemoveElement(/datum/element/ghost_role_eligibility, free_ghosting = TRUE, _role_eligible = FALSE)
