...
/datum/antagonist/heretic/training/greet()
	...
	to_chat(owner, span_notice("Другие еретики и их слуги защищены от ваших боевых заклинаний. Для проверки урона создайте учебную цель или попросите участника выбрать другую роль. Для проверки Жатвы Духа противник должен отходить от своей души: неподвижная цель возле неё избегает второго удара."))
