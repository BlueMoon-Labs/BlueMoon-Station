...
/datum/eldritch_knowledge/base_moon/get_combat_resource_data()
	return list(
		...
		"description" = "Копии наносят 5 / 8 / 10 физического и 18 / 24 / 30 урона выносливости раз в секунду на цель и выдерживают 30 / 40 / 50 урона. Броня снижает физический урон. Копии повторяют вашу речь, сохраняя язык и шёпот. Соседняя копия перехватывает снаряд ценой своей жизни, не чаще раза в 4 секунды; после вознесения - любая копия в двух клетках на открытой линии и без задержки. Обычные отражения живут 45 секунд; покров продлевает жизнь новых копий. Клинок направляет копии на вашу цель, обмен меняет вас местами до пяти клеток.",
	)
...
/datum/eldritch_knowledge/final_eldritch/moon_final
	...
	desc = "После трёх подношений принесите три человеческих трупа на руну. Начало обряда раскроет его место станции и даст экипажу 30 секунд, чтобы помешать. После вознесения вы получаете общую стойкость вознесения. До пяти отражений; удары наносят 10 физического и 30 урона выносливости с общим интервалом одна секунда на цель, а новые копии выдерживают 50 урона. Любая копия в двух клетках на открытой линии перехватывает снаряд без задержки. Открывается «Лунный маскарад»: до пяти ближайших видимых врагов в семи клетках получают 30 урона выносливости, путаются на 3 секунды и на 12 секунд становятся лунатиками, чьи выстрелы уходят в сторону; рядом с каждым на 10 секунд встаёт копия, которая нападает на него и не занимает место в пределе. Перезарядка 40 секунд. Слабость - свет: чужая вспышка флешера или флешбанга в трёх клетках от вас разбивает все ваши копии в трёх клетках и ослепляет вас на 2 секунды."
