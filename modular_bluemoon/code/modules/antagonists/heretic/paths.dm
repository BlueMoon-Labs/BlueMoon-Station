...
/datum/heretic_path/blade
	...
	capture_summary = "Клинок у горла держит сбитого или обезоруженного соседа до 12 секунд, а цель охоты уводит разрезом в изнанку."
...
/datum/heretic_path/moon
	...
	craft_summary = "Хватка в «Помощи» ставит двойника-алиби на 10 минут; отдел, где его увидит экипаж, засчитывается в дело."
