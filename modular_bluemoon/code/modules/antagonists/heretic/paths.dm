...
/datum/heretic_path/ash
	...
	strengths = "Мобильность, цепные поджоги, восстановление в бою. После вознесения за вами тянется огненный след, а пока вы сухи, собственный огонь лечит ожоги."
	weaknesses = "Нужна близкая дистанция; огнетушитель лишает вас части давления. Вода и пена гасят пламя вознесённого на 7 секунд: без следа и без лечения."
	knowledge = list(
...
/datum/heretic_path/rust
	...
	strengths = "Подготовленные позиции, разрушение укреплений и лечение на ржавчине. После вознесения Ржавое сердце растит ржавчину по станции, а на ржавом полу вы получаете вдвое меньше урона выносливости."
	weaknesses = "За пределами подготовленной территории вы заметно слабее. Вознесённого выманивают с ржавчины, а разбитое Ржавое сердце навсегда останавливает расползание и лечение на ржавом полу."
	knowledge = list(
...
/datum/heretic_path/flesh
	...
	strengths = "Слуги, разведка, дистанционная поддержка и лечение группы. После вознесения Повелитель Ночи пожирает трупы: каждое тело за 3 секунды восстанавливает червю 100 здоровья и отращивает сегмент, до 16 сегментов."
	weaknesses = "Призывы требуют добровольцев; потерянную свиту нужно восстанавливать. Червь вознесённого огромен и заметен издалека, его сегменты рубятся по одному, и с каждым отпадает весь хвост за ним. Урон по червю срывает трапезу, а убитая голова выбрасывает еретика в человеческом теле на 2 минуты, после которых червь возвращается вполовину раненым."
	knowledge = list(
...
/datum/heretic_path/void
	...
	name = "Пустота"
	desc = "Сковывайте врагов каждой боевой способностью, расставляйте очаги зимы и выбирайте место схватки. Замедление обновляется от попаданий и полей, проходит через 4 секунды без воздействия и не складывается само с собой."
	strengths = "Контроль пространства, замедление, молчание и перемещение. После вознесения безвоздушная буря разворачивает назад часть снарядов."
	weaknesses = "Для поддержания скованности нужно попадать способностями или держать врага в поле. Антимагия блокирует воздействие. Вознесённого глушит тепло: горящий или разогретый еретик не отклоняет снаряды, а его аура и буря затихают."
	knowledge = list(
...
/datum/heretic_path/blade
	...
	strengths = "Парирование, быстрое сближение, круговой разрез и пополнение Темпа обычными ударами. Вознёсшегося окружают клинки орбиты, отбивающие удары и выстрелы, а Буря клинков бросает их во врагов."
	weaknesses = "Для парирования вторая рука должна быть пустой или держать хватку; стойка короткая, а каждый удар и снаряд расходует её запас блоков. Орбиту вознесённого сдирает один выстрел картечи, а на расстоянии его клинок не лечит."
	knowledge = list(
...
/datum/heretic_path/moon
	...
	name = "Луна"
	desc = "Изматывайте и раньте врагов двойниками, прикрывайтесь ими от выстрелов и меняйтесь с ними местами."
	strengths = "Давление на выносливость, перехват снарядов и быстрый обмен местами. После вознесения копии в двух клетках на открытой линии ловят выстрелы без задержки, а «Лунный маскарад» сбивает врагам прицел на 12 секунд."
	weaknesses = "Двойники бьют слабее клинка и разбиваются от пары ударов или выстрелов; обмен требует видимости и свободного пола. Вознёсшегося выдаёт свет: чужая вспышка флешера или флешбанга в трёх клетках разбивает копии рядом и ослепляет его на 2 секунды."
	knowledge = list(
...
/datum/heretic_path/cosmic
	...
	strengths = "Быстрая расстановка ловушек, атака через звёздную дорогу и взрыв по площади. После вознесения под шагами сами загораются звёзды, космос не сносит, а призванный Звездочёт раз в 3 секунды бьёт лучом ближайшего врага."
	weaknesses = "Звёзды видны и разрушаются, нулевой жезл гасит их касанием; на неподготовленной позиции мало возможностей. Звездочёт вознесённого - крупная отдельная цель, которую берёт только летальное оружие: убитый, он вернётся к хозяину лишь через 3 минуты."
	knowledge = list(
