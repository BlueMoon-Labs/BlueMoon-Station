...
/datum/eldritch_knowledge/base_void
	...
	combat_resource_desc = "Активируйте метки клинком или стойте на открытом полу холоднее нуля (раз в 20 секунд). Если запас пуст, один осколок восстанавливается на открытом полу даже в тепле; задержка та же. Зимний предел расходует осколок и оставляет на 15 секунд область 5×5: враги в ней замедляются и теряют голос. Скованность проходит через 4 секунды после выхода."
...
/obj/effect/proc_holder/spell/self/heretic_power/void
	name = "Зимний предел"
	desc = "Потратьте осколок зимы: создайте область холода 5×5 на 15 секунд. Противники замедляются и теряют голос внутри; скованность проходит через 4 секунды после выхода. На руне внутри своего поля можно изготовить клинок Пустоты без охлаждения воздуха. Одновременно существует одна область."
