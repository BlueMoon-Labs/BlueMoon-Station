...
/datum/heretic_deed/ash
	...
	desc = "Гасите чужое пламя Хваткой Мансуса: очаг пожара (коснитесь горящего пола), зажжённый сварочник, зажигалку, свечу или факел, лежащие на полу. Огонь в руках даёт уголёк, но в дело не засчитывается. Каждый новый отдел засчитывается один раз."
