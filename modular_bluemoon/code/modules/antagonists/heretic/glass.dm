...
/datum/heretic_path/glass
	...
	strengths = "Дальний удар без подготовки, общий залп призм с наведением на выбранную клетку, преломление за углы и отражающие энергетические выстрелы преграды."
