// TRAIT_SUPERMATTER_SOOTHER (skillchip "Psychologist") - a trained psychologist's presence calms their own vision of the supermatter;
// the peek at the crystal is soothing and causes far weaker hallucinations.
