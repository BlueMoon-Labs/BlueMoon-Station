...
/obj/item/organ/heart/bioaegis/on_life()
	...
	owner.adjustBruteLoss(-healBrute, FALSE)
	owner.adjustFireLoss(-healFire, FALSE)
	owner.adjustToxLoss(-healTox, TRUE)
...
/obj/item/organ/heart/bioaegis/t2
	...
	healBrute = 0.4
	healOxy = 0.4 //It can pump blood rather well, so it can delay oxy damage to some degree.
