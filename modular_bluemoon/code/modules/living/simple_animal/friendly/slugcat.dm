/mob/living/simple_animal/pet/slugcat
	...
	//icon_resting = "slugcat_rest" у нас не эта переменная
	...
	//attacktext = "бьёт" ХЗ куда это
	mob_size = MOB_SIZE_SMALL
	pass_flags = PASSTABLE
	//ventcrawler = VENTCRAWLER_ALWAYS // у нас для этого другой прок
	//can_collar = TRUE // у нас нет механа ошейников на питомцев
	...
	//tts_seed = "Narrator" // у нас нет ТТса
