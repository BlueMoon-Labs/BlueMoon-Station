...
/datum/design/nanite_protector
	...
	desc = "Экспериментальный инжектор, содержит серую массу, непонятного происхождения, при попадании в организм необратимо меняет клетки и перестраивает конструкции, не давая им взаимодействовать с нанитами. Использование более одного раза не несет эффекта."
	id = "nanite_protector"
	build_type = PROTOLATHE
