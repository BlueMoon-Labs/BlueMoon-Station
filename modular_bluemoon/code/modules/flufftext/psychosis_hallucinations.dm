	...
	if(prob(45))
		...
		if(source)
			target.playsound_local(source, pick(
				...
				'sound/hallucinations/psychosis/whisper_voices_1.ogg',
				'sound/hallucinations/psychosis/whisper_voices_2.ogg',
				'sound/hallucinations/psychosis/whisper_spells.ogg',
				'sound/hallucinations/psychosis/whisper_vocal.ogg',
				), 25, TRUE)
	qdel(src)
...
/datum/hallucination/psychosis/shadow/New(mob/living/carbon/C, forced = TRUE)
	set waitfor = FALSE
	..()
	var/turf/spawn_turf = random_far_turf()
	if(!spawn_turf)
		qdel(src)
		return
...
/datum/hallucination/psychosis/presence/New(mob/living/carbon/C, forced = TRUE)
	...
	target.playsound_local(source, pick(
		...
		'sound/misc/cluwne_breathing.ogg',
		'sound/hallucinations/psychosis/breath_creature_1.ogg',
		'sound/hallucinations/psychosis/breath_creature_2.ogg',
		'sound/hallucinations/psychosis/breath_ghostly.ogg',
		'sound/hallucinations/psychosis/breath_ominous.ogg',
		'sound/hallucinations/psychosis/ghosthunt.ogg',
		), 30, TRUE)
	qdel(src)
...
/datum/hallucination/psychosis/distorted_radio/New(mob/living/carbon/C, forced = TRUE)
	...
	target.playsound_local(target, 'sound/effects/sparks1.ogg', 35, TRUE)
...
/datum/hallucination/psychosis/laughter/New(mob/living/carbon/C, forced = TRUE)
	...
	target.playsound_local(source, pick(
		'sound/spookoween/insane_low_laugh.ogg',
		'sound/spookoween/ahaha.ogg',
		'sound/hallucinations/psychosis/laugh_minkie.ogg',
		'sound/hallucinations/psychosis/laugh_growl.ogg',
		'sound/hallucinations/psychosis/laugh_creepy.ogg',
		'sound/hallucinations/psychosis/laugh_child.ogg',
		'sound/hallucinations/psychosis/laugh_evil.ogg',
		), 35, TRUE)
	qdel(src)
...
/datum/hallucination/psychosis/distant_scream/New(mob/living/carbon/C, forced = TRUE)
	...
	target.playsound_local(source, pick(
		...
		'sound/creatures/ph_scream1.ogg',
		'sound/voice/deathgasp1.ogg',
		'sound/voice/deathgasp2.ogg',
		'sound/hallucinations/psychosis/scream.ogg',
		'sound/hallucinations/psychosis/stinger_cruel.ogg',
		), 45, TRUE)
	qdel(src)
...
/datum/hallucination/psychosis/clock_ticks/New(mob/living/carbon/C, forced = TRUE)
	...
	for(var/i in 1 to ticks)
		if(QDELETED(target) || target.stat == DEAD)
			break
		target.playsound_local(target, 'sound/effects/clock_tick.ogg', 30, FALSE)
		sleep(delay)
		delay = max(2, delay - 1)
	qdel(src)
...
/datum/hallucination/psychosis/phantom_steps/New(mob/living/carbon/C, forced = TRUE)
	...
	for(var/i in 1 to steps)
		if(QDELETED(target) || target.stat == DEAD)
			break
		target.playsound_local(current, pick(
...
/datum/hallucination/psychosis/chains_rattle/New(mob/living/carbon/C, forced = TRUE)
	...
	target.playsound_local(source, pick(
		'sound/spookoween/chain_rattling.ogg',
		'sound/hallucinations/psychosis/creaking_structure.ogg',
		'sound/hallucinations/psychosis/swishes.ogg',
		), 35, TRUE)
	qdel(src)
...
/datum/hallucination/psychosis/horror_alarm/New(mob/living/carbon/C, forced = TRUE)
	...
	target.playsound_local(source, pick(
		'sound/hallucinations/psychosis/alarm_scifi_1.ogg',
		'sound/hallucinations/psychosis/alarm_scifi_2.ogg',
		'sound/hallucinations/psychosis/alarm_scifi_3.ogg',
		), 40, TRUE)
	qdel(src)
...
/datum/hallucination/psychosis/distant_horn/New(mob/living/carbon/C, forced = TRUE)
	...
	target.playsound_local(source, pick(
		'sound/hallucinations/psychosis/foghorn_distant.ogg',
		'sound/hallucinations/psychosis/train_distant.ogg',
		'sound/hallucinations/psychosis/whalesong_monotron.ogg',
		'sound/hallucinations/psychosis/bass_drum.ogg',
		), 30, TRUE)
	qdel(src)
...
/datum/hallucination/psychosis/void_drone/New(mob/living/carbon/C, forced = TRUE)
	...
	target.playsound_local(target, pick(
		'sound/hallucinations/psychosis/ambient_atmosphere.ogg',
		'sound/hallucinations/psychosis/ambient_noise.ogg',
		), 35, FALSE)
	qdel(src)
...
/datum/hallucination/psychosis/phantom_flatline/New(mob/living/carbon/C, forced = TRUE)
	...
	for(var/i in 1 to beeps)
		if(QDELETED(target) || target.stat == DEAD)
			break
		target.playsound_local(source, 'sound/machines/twobeep_high.ogg', 22, FALSE)
		sleep(rand(8, 14))
	if(!QDELETED(target) && target.stat != DEAD)
		target.playsound_local(source, 'sound/machines/defib_failed.ogg', 30, FALSE)
	qdel(src)
...
/datum/hallucination/psychosis/phantom_bone_crack/New(mob/living/carbon/C, forced = TRUE)
	...
	target.playsound_local(target_T, pick(
...
/datum/hallucination/psychosis/phantom_blood_drip/New(mob/living/carbon/C, forced = TRUE)
	...
	for(var/i in 1 to count)
		...
		D.Show()
		drops += D
		target.playsound_local(spawn_turf, 'sound/effects/splat.ogg', 22, FALSE)
		sleep(rand(6, 10))
...
/datum/hallucination/psychosis/phantom_sparks/New(mob/living/carbon/C, forced = TRUE)
	...
	target.playsound_local(spawn_turf, 'sound/effects/sparks1.ogg', 25, TRUE)
	QDEL_IN(src, 12)
...
/datum/hallucination/psychosis/static_flash/New(mob/living/carbon/C, forced = TRUE)
	...
	target.playsound_local(target, 'sound/effects/sparks1.ogg', 20, TRUE)
	sleep(rand(4, 8))
	if(!QDELETED(target))
...
/datum/hallucination/psychosis/memory_flash/New(mob/living/carbon/C, forced = TRUE)
	...
	target.playsound_local(target, 'sound/hallucinations/psychosis/buildup_memories.ogg', 28, FALSE)
	qdel(src)
...
/datum/hallucination/psychosis/countdown/New(mob/living/carbon/C, forced = TRUE)
	...
	for(var/i in start_index to length(sequence))
		...
		target.playsound_local(target, 'sound/effects/clock_tick.ogg', 25, FALSE)
		sleep(delay)
		delay = max(6, delay - 2)
	if(!QDELETED(target) && target.stat != DEAD)
