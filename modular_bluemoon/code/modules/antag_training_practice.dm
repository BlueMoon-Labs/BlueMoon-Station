...
/datum/heretic_path/lock
	combat_practice = "Запечатайте свободную клетку рядом с целью и пройдите сквозь свою печать. Изучив Открывающий удар, выберите печать и не двигайтесь секунду: она взорвётся рядом с целью. Сравните со снятием печати рукой на помощи — оно возвращает ключ, а взрыв расходует печать."
...
/datum/heretic_path/blood
	combat_practice = "Свяжите цель, нанесите несколько ударов клыком для накопления долга и выберите должника способностью «Связать / взыскать». Не разрывайте видимость во время предупреждения; на разоружении взыскивается только часть долга."
...
/datum/heretic_path/spirit
	combat_practice = "На человеческой цели примените Разлучение, затем, изучив «Душа на ладони», отойдите на 3–5 клеток и бесплатно примените «Сместить душу». Стойте секунду: душа сместится на две клетки, а тело начнёт терять выносливость — её урон виден в разделе «Цели». Дальше примените Жатву и бейте тело крюком. Для Переправы к душе включите «Разоружить», чтобы сохранить связь; сбор рукой или Переправой в другом намерении отменяет второй удар Жатвы. Жертва может вернуть душу касанием: смещение заставляет её подойти к силуэту. Для проверки этого противодействия используйте дуэль с другим игроком."
