...
/datum/heretic_path/spirit
	combat_practice = "Примените Разлучение, затем, изучив «Душа на ладони», отойдите от души на 3–5 клеток и выберите её способностью «Сместить душу». Через секунду душа подойдёт к вам на две клетки: оставшаяся у прежней позиции мишень начнёт терять выносливость. Повторить смещение этой души нельзя; её срок и предел истощения сохраняются. Касание души жертвой или её разрушение обрывает связь."
