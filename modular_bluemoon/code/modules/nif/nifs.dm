...
/obj/item/organ/cyberimp/brain/nif
	...
	var/calibration_time = 30 SECONDS
	...
	var/good_sound ='modular_bluemoon/code/modules/nif/sounds/default_good.ogg'
	///This is the sound that plays if there is an issue going on.
	var/bad_sound = 'modular_bluemoon/code/modules/nif/sounds/default_bad.ogg'
	///This is the sound that you would hear if you enable if you activate or enable something.
	var/click_sound = 'modular_bluemoon/code/modules/nif/sounds/default_click.ogg'
...
/obj/item/organ/cyberimp/brain/nif/Insert(mob/living/carbon/insertee, special = 0, drop_if_replaced = TRUE)
...
/datum/component/nif_examine/New()
	...
	RegisterSignal(parent, COMSIG_PARENT_EXAMINE, PROC_REF(add_examine))
...
/mob/living/carbon/human/proc/find_nifsoft(datum/nifsoft/nifsoft_to_find)
	var/obj/item/organ/cyberimp/brain/nif/installed_nif = getorgan(/obj/item/organ/cyberimp/brain/nif)
...
/datum/asset/spritesheet_batched/chat/create_spritesheets()
	. = ..()
	insert_all_icons("nif", 'modular_bluemoon/code/modules/nif/icons/obj/chat.dmi')
