...
/datum/nifsoft/hivemind/New()
	...
	linked_mob.AddComponent(/datum/component/mind_linker/active_linking/nif, \
		network_name = "Hivemind Link", \
		linker_action_path = /datum/action/innate/hivemind_config, \
	)
	user_network = linked_mob.GetComponent(/datum/component/mind_linker/active_linking/nif)
...
/datum/nifsoft/hivemind/activate()
	...
	linked_keyboard.source_user = WEAKREF(linked_mob)
...
/datum/action/innate/hivemind_config
	...
	icon_icon = 'modular_bluemoon/code/modules/nif/icons/mob/actions/actions_nif.dmi'
...
/datum/component/mind_linker/active_linking/nif
	...
	var/name = "Hivemind Link"

/datum/component/mind_linker/active_linking/nif/Initialize(
...
/datum/component/mind_linker/active_linking/nif/proc/change_chat_color()
	var/mob/living/carbon/human/owner = parent
	var/new_chat_color = input(owner, "Pick new color", "Hivemind Chat Color", COLOR_ASSEMBLY_GREEN) as color|null
