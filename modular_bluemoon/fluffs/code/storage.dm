...
/obj/item/storage/box/kumiko_ncr_case/PopulateContents()
	...
	new	/obj/item/clothing/suit/donator/bm/kumiko_ncr_recon(src)
	new	/obj/item/clothing/suit/donator/bm/kumiko_ncr_combat_duster(src)
	new	/obj/item/clothing/suit/donator/bm/kumiko_ncr_desert(src)
	...
	new	/obj/item/clothing/suit/donator/bm/kumiko_ncr_price(src)
	new	/obj/item/modkit/kumiko_ncr_plate_carrier(src)
	new	/obj/item/clothing/head/donator/bm/kumiko_ncr_helmet(src)
	new	/obj/item/clothing/head/donator/bm/kumiko_ncr_desert_helmet(src)
