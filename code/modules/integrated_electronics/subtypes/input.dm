...
/obj/item/integrated_circuit/input/ntnet_packet
    ...
    подаст импульс на подключенное к нему устройство. Импульс на первом пине активации приведет к отправке сообщения. Когда отправка успешна, \
	третий пин активации подаст импульс. Сообщения \
