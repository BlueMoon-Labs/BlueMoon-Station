/// Simple modifier for whether this mob can handle greater or lesser skillchip complexity.
/mob/living/carbon
 ...
 *
 * Returns msg/reason when a check fails, FALSE on failure, or TRUE on success.
 * Arguments:
 ...
 * Arguments:
 * * skillchip - The skillchip you want to remove.
