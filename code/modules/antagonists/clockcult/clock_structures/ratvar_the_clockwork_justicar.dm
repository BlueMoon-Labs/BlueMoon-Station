...
/obj/structure/destructible/clockwork/massive/ratvar/proc/clash_of_the_titans(obj/singularity/narsie/narsie)
	...
	switch(winner)
		if("Ratvar")
			send_to_playing_players("<span class='heavy_brass'><font size=5>\"[pick("СДОХНИ.", "ГНИ ВЕКАМИ, КАК Я!.", "ПОГИБНИ, ЯЗЫЧНИК.", "СДОХНИ, МОНСТР, ТЫ НЕ МЕСТО В ЭТОМ МИРЕ.")]\"</font></span>\n\
