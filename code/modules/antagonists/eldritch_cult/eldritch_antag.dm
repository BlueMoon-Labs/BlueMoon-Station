...
/datum/objective/sacrifice_ecult/update_explanation_text()
	. = ..()
	explanation_text = "Принесите [target_amount] разных назначенных душ на руне трансмутации. Живая цель в крите, без сознания, в наручниках, лёжа или оглушённая даёт 2 очка знаний и 1 побочное, а затем возвращается из Мансуса. Труп назначенной цели тоже засчитывается, но даёт только 1 очко знаний и остаётся на месте."
