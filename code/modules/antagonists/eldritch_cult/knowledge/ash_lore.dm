...
/datum/eldritch_knowledge/ashen_grasp
	...
	desc = "Хватка Мансуса поджигает врага, обжигает глаза и затуманивает зрение. Если цель загорелась или уже горит, вы получаете уголёк, не чаще раза в 15 секунд."
	cost = 1
	route = PATH_ASH
...
/datum/eldritch_knowledge/spell/flame_birth
	...
	desc = "Погасите огонь на себе и вытяните жар из четырёх горящих врагов в пределах 4 клеток. Каждый получает 15 ожогов и восстанавливает вам по 10 ушибов и ожогов. Сначала подожгите противников хваткой, клинком или Угасанием."
...
/datum/eldritch_knowledge/flame_immunity
	...
	desc = "Вы невосприимчивы к огню и жаре. Соедините зажигалку, мензурку и лист бумаги, чтобы создать кадильницу углей: собирайте пламя с горящих существ или забирайте собственный угольный след с пола; выпускайте его конусом, расходуя уголёк."
...
/datum/eldritch_knowledge/ash_blade_upgrade
	...
	desc = "Клинок наносит 2 прямых ожога и поджигает жертву. Улучшения усиливают прямой урон и количество огня, поэтому клинок полезен и против негорящих тел."
...
/datum/eldritch_knowledge/final_eldritch/ash_final
	...
	desc = "После трёх подношений принесите три мёртвых тела на руну. Начало обряда раскроет его место всей станции и даст экипажу 30 секунд, чтобы помешать. После вознесения вы получаете общую стойкость вознесения, защиту от возгорания и жары и становитесь Пепельным владыкой. Пока вы сухи, вас окутывает безвредное для вас пламя: этот огонь лечит ожоги, по 3 каждые 2 секунды (ушибы он не трогает), а на каждой покинутой клетке остаётся огненный след на 4 секунды. След поджигает врагов, но не трогает еретиков, их слуг и защищённых от магии, и не поджигает газ. Вода и пена гасят пламя на 7 секунд: всё это время нет ни следа, ни лечения. Вы получаете Огненный каскад (волна на 10 клеток, перезарядка 30 секунд) и Клятву огня (кольцо огня на минуту, перезарядка 2 минуты). Смерть снимает эти усиления, оживление возвращает."
