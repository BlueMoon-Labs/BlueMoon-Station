/datum/eldritch_knowledge/base_ash
	...
	desc = "Открывает Путь Пепла: поджигайте врагов, собирайте угольки и отступайте через собственное пламя. \
		Спичка и кухонный нож превращаются в пепельный клинок. Угасание расходует уголёк, тушит вас, лечит и оставляет огненный след."
...
/datum/eldritch_knowledge/curse/corrosion
	...
	desc = "Наложите на человека проклятие: 2 минуты рвоты и серьёзных повреждений органов. Для обряда нужны кусачки, лужа крови, сердце, левая и правая рука, а также предмет, к которому жертва прикасалась голыми руками."
	cost = 1
...
/datum/eldritch_knowledge/curse/paralysis
	...
	desc = "Наложите на жертву проклятие, которое лишит её возможности ходить на 5 минут. Принесите в жертву нож, лужу крови, пару ног, топор и предмет, к которому жертва прикасалась голыми руками. "
	cost = 1
