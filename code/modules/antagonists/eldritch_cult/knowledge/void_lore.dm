...
/datum/eldritch_knowledge/final_eldritch/void_final
	...
	desc = "После трёх подношений принесите три мёртвых тела на руну. Начало обряда раскроет его место всей станции и даст экипажу 30 секунд, чтобы помешать. После вознесения вы не нуждаетесь в дыхании, защищены от холода, высокого и низкого давления и получаете на 25% меньше ушибов и ожогов. Вас окружает зимняя буря. Последний такт наносит видимым врагам в пределах 5 клеток 30 холодовых ожогов, замедляет на 4 секунды, оттесняет на две клетки, охлаждает и отмечает их, оставляя зимний круг радиусом три клетки на 12 секунд. Аура в пределах 5 клеток поддерживает охлаждение и скованность; голос подавляют только активные зимние поля."
