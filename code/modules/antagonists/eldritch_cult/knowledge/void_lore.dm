/datum/eldritch_knowledge/base_void
	name = "Мерцание зимы"
	desc = "Открывает Путь Пустоты: собирайте осколки зимы, оставляйте холодные зоны и выбирайте дистанцию боя. Нож на руне при температуре не выше 0 °C или внутри вашего Зимнего предела превращается в клинок Пустоты. Зимний предел создаёт область холода и молчания."
