...
/datum/eldritch_knowledge/base_rust
	...
	details = list(
		...
		"Готовую цель на ржавчине своего очага сердце уводит в изнанку за 1 секунду; из изнанки очаг - выход.",
...
/datum/eldritch_knowledge/spell/area_conversion
	...
	details = list(
		...
		"Семя в руке на ржавеющем полу: 3 секунды и 1 нарост - очаг 5×5 на 60 секунд.",
		"Очаг лечит вас и свиту на ржавчине; он один на хозяина, семя тратится, задержка 20 секунд.",
		"Касание очага пустой рукой на «Вреде»: через секунду он лопается, 18 урона коррозией врагам рядом.",
...
/datum/eldritch_knowledge/final_eldritch/rust_final
	...
	details = list(
		...
		"Ржавое сердце на 300 прочности растёт на руне (над космосом или в завале - у ног) и растит ржавчину.",
		...
		"Слабость: сердце видно и бьётся оружием; разбитое, оно навсегда снимает силу вознесения с ржавого пола.",
	)
