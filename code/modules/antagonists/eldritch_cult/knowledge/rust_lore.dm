/datum/eldritch_knowledge/base_rust
	...
	desc = "Открывает Путь Ржавчины: превращайте станцию в свою территорию и выращивайте лечащие очаги. Нож и мусор превращаются в ржавый клинок. Укоренение расходует нарост и создаёт временный ржавый очаг."
