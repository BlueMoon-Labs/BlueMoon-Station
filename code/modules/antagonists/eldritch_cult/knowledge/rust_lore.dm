...
/datum/eldritch_knowledge/base_rust
	...
	desc = "Открывает Путь Ржавчины. Хватка разрушает обычные шлюзы, ржавит полы и стены; повторное касание сносит ржавую стену. Укреплённые стены сопротивляются с шансом 50%. Новая поверхность даёт нарост раз в 15 секунд. Укоренение расходует нарост и создаёт лечащий очаг. Нож и мусор превращаются в ржавый клинок."
...
/datum/eldritch_knowledge/rust_fist
	...
	desc = "Хватка сразу разрушает обычную стену, покрывая её ржавчиной и обрушая за одно касание. Укреплённые стены по-прежнему требуют сначала проржавить, затем разрушить; каждое касание имеет шанс успеха 50%."
...
/datum/eldritch_knowledge/rust_mark
	name = "Метка Ржавчины"
	desc = "Хватка накладывает Метку Ржавчины. Удар ржавым клинком активирует её: 15 урона коррозией (5 ожогов и 10 отравления или повреждения систем), повреждение предметов в руках и верхней одежды, один нарост для Укоренения. Метка сама не уничтожает снаряжение. Слизни и борги получают только ожоги."
...
/datum/eldritch_knowledge/spell/area_conversion
	...
	desc = "Распространяет ржавчину по ближайшим поверхностям; заржавевшие стены разрушаются. Соедините сердце, кабель и железо, чтобы создать семя ржавчины. Один нарост позволит посадить его на минуту: разрушаемый очаг расширяет ржавчину и лечит хозяина со свитой. Коснитесь сердца на вреде, чтобы после секунды подготовки пожертвовать им ради 18 урона коррозией врагам в области."
...
/datum/eldritch_knowledge/spell/rust_wave
	...
	desc = "Выпускает заряд ржавчины, который отравляет цель и оставляет ржавый проход. Это побочное знание доступно любому пути; оно не даёт лечение и другие преимущества Пути Ржавчины."
...
/datum/eldritch_knowledge/rust_blade_upgrade
	...
	desc = "Каждое ранение ржавым клинком наносит 5 урона коррозией: треть ожогами, остальное отравлением или повреждением систем синтетика. Слизни и борги получают только ожоги; коррозия никого не лечит."
...
/datum/eldritch_knowledge/spell/entropic_plume
	...
	desc = "Волна ржавчины ослепляет и дезориентирует врагов, заставляя их нападать на окружающих. Наносит от 10 урона коррозией вблизи до 2 на краю: треть ожогами, остальное отравлением или повреждением систем синтетика. Слизни и борги получают только ожоги. Поверхности на её пути покрываются ржавчиной."
...
/datum/eldritch_knowledge/essence
	...
	desc = "Соедините бак с водой и осколок стекла, чтобы получить 50 единиц древней эссенции. Для еретика она лечит раны и отравление, восстанавливает 30 выносливости и сокращает оглушение и неподвижность на 8 секунд при каждом усвоении. Выпейте заранее: оглушение мешает пользоваться предметами. Эссенция не даёт иммунитета к новым ударам; для непосвящённых это яд."
...
/datum/eldritch_knowledge/final_eldritch/rust_final
	...
	desc = "После трёх подношений принесите три мёртвых тела на руну. Начало обряда раскроет его место всей станции и даст экипажу 30 секунд, чтобы помешать. После вознесения вы получаете общую стойкость вознесения и защиту от жары. На руне вырастает Ржавое сердце (300 прочности); если руна над космосом или завалена, оно вырастет у ваших ног. Пока сердце цело, от него по станции расползается ржавчина, а на ржавом полу вы дополнительно лечите ушибы, ожоги, отравление и удушье, восстанавливаете выносливость и получаете вдвое меньше урона выносливости. Вне ржавчины эти усиления не действуют. Сердце видно экипажу и разбивается обычным оружием: тогда расползание и все усиления ржавого пола прекращаются навсегда, остаётся только общая стойкость. «Коррозийный вал» бьёт всё, что видно в пяти клетках вокруг вас (за стены и глухие двери не проходит): 20 урона коррозией врагам, полы ржавеют, обычные стены рушатся (наружные, за которыми космос, пропасть, лава или вода, вал не трогает), укреплённые могут лишь заржаветь, корпус шаттлов не поддаётся. Вал не оглушает, перезарядка 40 секунд. Смерть снимает эти усиления, оживление возвращает."
...
/datum/eldritch_knowledge/final_eldritch/rust_final/proc/on_heart_destroyed(datum/source)
	...
	if(master?.current)
		to_chat(master.current, span_userdanger("Ржавое сердце разбито! Ржавчина больше не расползается, а ржавый пол больше не лечит и не бережёт ваши силы."))
