...
/datum/eldritch_knowledge/flesh_ghoul
	...
	desc = "Мёртвый человек, мак и 2 биомассы создают Безмолвного мертвеца: слугу с 90 здоровья, лишённого голоса. Одновременно можно удерживать двух. Если душа тела не возвращается, роль предлагается призракам. Истощённые и уже поднятые тела не подходят. Хватка на разоружении превращает извлечённый орган на полу и 2 биомассы в сшитого ползуна без призрака: 40 здоровья, 6 урона раз в 2 секунды, срок 90 секунд. Один ползун занимает место в общей свите. Живой шов указывает ему врага; касание ползуна на помощи возвращает его к вам. Дальше 9 клеток от хозяина он распадается."
...
/datum/eldritch_knowledge/flesh_blade_upgrade
	...
	desc = "Ранения клинком плоти наносят 2 дополнительных ушиба и поддерживают кровотечение. Улучшения увеличивают прямой урон и срок кровотечения, а не скорость потери крови. Бескровные тела получают прямой урон."
...
/datum/eldritch_knowledge/final_eldritch/flesh_final
	...
	desc = "После трёх подношений принесите три мёртвых тела на руну. Начало обряда раскроет его место всей станции и даст экипажу 30 секунд, чтобы помешать. После вознесения в человеческом теле вы получаете на 25% меньше ушибов и ожогов. Вознесение позволяет принять форму Повелителя Ночи. Предел гулей и Безмолвных мертвецов увеличивается до четырёх каждого вида; общий предел всей свиты — восемь слуг."
