...
/obj/effect/proc_holder/spell/aoe_turf/domain_expansion
	...
	desc = "После трёх секунд сосредоточения создайте домен 7×7 на 20 секунд. Он замедляет врагов и накладывает метки Пустоты; союзники свободно проходят через него. Скованность проходит через 4 секунды после выхода."
	charge_max = 900
	clothes_req = FALSE
	invocation_type = "none"
	range = 0
