...
/obj/effect/proc_holder/spell/self/heretic_summon/proc/hide_item(obj/item/I, datum/antagonist/heretic/heretic)
	...
	if(hide_sound)
		playsound(M, hide_sound, 100, TRUE, -SOUND_RANGE+2, SOUND_FALLOFF_EXPONENT*4, falloff_distance = 0)
...
/obj/effect/proc_holder/spell/self/heretic_summon/proc/summon_item(obj/item/I, mob/living/carbon/human/user)
	if(!istype(user))
		return
	if(summon_sound)
		playsound(user, summon_sound, 100, TRUE, -SOUND_RANGE+2, SOUND_FALLOFF_EXPONENT*4, falloff_distance = 0)
