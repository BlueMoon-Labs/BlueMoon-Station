...
/datum/eldritch_knowledge/spell/basic
	ritual_hint = "Нужна назначенная в главе «Охота» цель. Живой человек должен быть в крите, без сознания, связан наручниками, лежать или быть оглушён. Для цели в крите наручники не нужны, даже если она ещё стоит. Ваше живое сердце сохраняется после обряда; труп назначенной цели тоже остаётся на месте. Дион приносите живыми: при смерти они распадаются на нимф и не оставляют подходящего тела. Если цель распалась, выберите новую через сердце."
	name = "Обряд возвращения"
	desc = "Положите своё живое сердце и назначенную цель на руну или рядом. Живую цель достаточно связать наручниками, оглушить или сбить с ног. Цель в крите принимается без наручников. За 8 секунд руна примет подношение; живую жертву она удерживает и защищает от кровотечения. Перемещение жертвы или прерывание еретика срывает обряд. Живая цель даёт 2 очка знаний и 1 побочное, проходит через Мансус и возвращается живой не позднее чем через 45 секунд. Труп назначенной цели даёт только 1 очко знаний без побочного: тело остаётся на месте, его можно реанимировать. Оба варианта засчитываются для вознесения. Одну душу можно принести лишь однажды за раунд, даже после реанимации."
...
/datum/eldritch_knowledge/codex_cicatrix
	name = "Кодекс Рубцов"
	ritual_hint = "Это изготовление запасной книги. Сначала используйте способность «Призвать кодекс»: выданная в начале книга уже спрятана за завесой и не требует компонентов. Потерянный личный кодекс можно вернуть за 20 секунд неподвижности, если его не удерживает чужой инвентарь, контейнер или обряд."
