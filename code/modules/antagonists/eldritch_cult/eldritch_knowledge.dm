...
/datum/eldritch_knowledge/spell/basic
	...
	desc = "Положите живое сердце и назначенную живую цель без сознания на руну. На время 15-секундного обряда цель погрузится в стазис, затем попадёт в Мансус и вернётся живой не позднее чем через 45 секунд. Каждая душа даёт два очка знаний и одно очко побочных знаний; одну душу можно принести лишь однажды за раунд."
	gain_text = "За гранью сна мне назвали первое имя."
	spell_to_add = /obj/effect/proc_holder/spell/targeted/touch/mansus_grasp
	required_atoms = list(/obj/item/living_heart)
	route = "Start"
	ritual_time = 15 SECONDS
