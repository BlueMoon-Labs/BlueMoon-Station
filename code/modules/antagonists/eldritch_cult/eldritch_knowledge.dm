...
/datum/eldritch_knowledge/codex_cicatrix
	name = "Кодекс Рубцов"
	ritual_hint = "Это изготовление запасной книги. Сначала используйте способность «Призвать кодекс»: уже выданная книга не требует компонентов."
