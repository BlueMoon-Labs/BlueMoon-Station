...
/datum/eldritch_knowledge/codex_cicatrix
	name = "Кодекс Рубцов"
	ritual_hint = "Это изготовление запасной книги. Сначала используйте способность «Призвать кодекс»: выданная в начале книга уже спрятана за завесой и не требует компонентов. Оставленную на станции книгу нужно подобрать, чтобы снова спрятать."
