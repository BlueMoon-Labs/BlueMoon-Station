...
/datum/eldritch_knowledge/final_eldritch
	ritual_hints = list(
		...
		"Здоровья 150, вы стоите до самого крита, ушибы и ожоги слабее на 40%, урон выносливости проходит на 30%.",
		"Оглушения, сбивания и обездвиживание вчетверо короче, электрошок почти не действует, раны не замедляют.",
		...
		"Экипаж видит при осмотре, что дубинки и станы вас почти не берут; светошумовые гранаты всё ещё валят.",
...
/datum/eldritch_knowledge/spell/basic
	...
	summary = "Живое сердце у обезвреженной назначенной цели проводит обряд: вам знания, её душе - Мансус."
	details = list(
		"Коснитесь цели живым сердцем или положите сердце и цель на руну; обряд длится 8 секунд.",
		"Живая цель годится в наручниках, оглушённой или сбитой с ног, цель в крите - и без наручников.",
		...
		"Круг держит живую жертву и не даёт ей истечь кровью; её сдвиг или прерывание еретика срывает обряд.",
		"Знание даёт Хватку Мансуса: 10 ушибов, 60 выносливости и 2 секунды на полу, перезарядка 12 секунд.",
	)
	role = HERETIC_ROLE_RITUAL
	ritual_hints = list(
		"Нужна назначенная в главе «Охота» цель.",
		"Руна не обязательна: касание обезвреженной цели сердцем проводит обряд прямо под телом.",
...
/datum/eldritch_knowledge/spell/summon/book
	...
	details = list(
		...
		"Запертый в шкафу или сумке - после 60 секунд; уничтоженный восстанавливается.",
...
/datum/eldritch_knowledge/living_heart
	...
	details = list(
		"Сожмите сердце, чтобы найти назначенную цель; Alt-ЛКМ вызывает новое имя.",
...
/datum/eldritch_knowledge/codex_cicatrix
	...
	role = HERETIC_ROLE_RITUAL
	ritual_hints = list(
		"Это запасная книга: выданная возвращается способностью без компонентов.",
