...
/datum/eldritch_knowledge/living_heart
	...
	ritual_hint = "Это изготовление запасного сердца. Для подношения назначенной цели положите рядом уже готовое живое сердце и выберите на руне «Обряд возвращения»."
