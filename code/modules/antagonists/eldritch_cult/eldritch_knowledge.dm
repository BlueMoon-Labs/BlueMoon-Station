...
/datum/eldritch_knowledge/spell/basic
	ritual_hint = "Нужна назначенная в главе «Охота» цель. Живой человек должен быть в крите, без сознания, связан наручниками, лежать или быть оглушён. Для цели в крите наручники не нужны, даже если она ещё стоит. Руна не обязательна: касание обезвреженной цели живым сердцем проводит тот же обряд прямо под телом. Ваше живое сердце сохраняется после обряда; труп назначенной цели тоже остаётся на месте. Дион приносите живыми: при смерти они распадаются на нимф и не оставляют подходящего тела. Если цель распалась, выберите новую через сердце."
	name = "Обряд возвращения"
	desc = "Положите своё живое сердце и назначенную цель на руну или рядом. Без руны коснитесь обезвреженной цели живым сердцем: круг проступит прямо под телом. Живую цель достаточно связать наручниками, оглушить или сбить с ног. Цель в крите принимается без наручников. За 8 секунд круг примет подношение; живую жертву он удерживает и защищает от кровотечения. Перемещение жертвы или прерывание еретика срывает обряд. Живая цель даёт 2 очка знаний и 1 побочное, проходит через Мансус и возвращается живой не позднее чем через 3 минуты. Труп назначенной цели даёт только 1 очко знаний без побочного: тело остаётся на месте, его можно реанимировать. Оба варианта засчитываются для вознесения. Одну душу можно принести лишь однажды за раунд, даже после реанимации."
...
/datum/eldritch_knowledge/living_heart
	...
	ritual_hint = "Это изготовление запасного сердца. Уже выданное сердце вызывается способностью «Призвать живое сердце»; потерянное возвращается после 5 секунд неподвижности. Для подношения положите готовое сердце рядом с целью и выберите «Обряд возвращения»."
...
/datum/eldritch_knowledge/codex_cicatrix
	name = "Кодекс Рубцов"
	ritual_hint = "Это изготовление запасной книги. Сначала используйте способность «Призвать кодекс»: выданная в начале книга уже спрятана за завесой и не требует компонентов. Потерянный личный кодекс можно вернуть за 20 секунд неподвижности, а из шкафа или сумки - за минуту, если его не удерживает чужой инвентарь или обряд."
