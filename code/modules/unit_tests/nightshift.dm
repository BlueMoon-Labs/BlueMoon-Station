...
/datum/unit_test/nightshift_light_colors/Run()
	...
	TEST_ASSERT(abs(default_light.light_power - default_light.nightshift_light_power) < 0.001, "Deep night should reach the configured nightshift power. Expected [default_light.light_power] to be close to [default_light.nightshift_light_power].")
	...
	TEST_ASSERT(abs(default_light.light.light_power - default_light.nightshift_light_power) < 0.001, "Deep-night emitted light should reach the configured nightshift power. Expected [default_light.light.light_power] to be close to [default_light.nightshift_light_power].")
...
/datum/unit_test/nightshift_relight_resync/proc/assert_deep_night_emission(message_prefix)
	...
	TEST_ASSERT(abs(test_light.light_power - test_light.nightshift_light_power) < 0.001, "[message_prefix] fixture power should match the deep-night power. Expected [test_light.light_power] to be close to [test_light.nightshift_light_power].")
	...
	if(test_light.light)
		...
		TEST_ASSERT(abs(test_light.light.light_power - test_light.nightshift_light_power) < 0.001, "[message_prefix] emitted light should match the deep-night power. Expected [test_light.light.light_power] to be close to [test_light.nightshift_light_power].")
