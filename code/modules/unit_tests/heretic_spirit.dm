...
/datum/unit_test/heretic_spirit_late_reap/Run()
	var/datum/antagonist/heretic/heretic = allocate_heretic(get_step(run_loc_floor_bottom_left, NORTHEAST))
	heretic.selected_path = PATH_SPIRIT
	for(var/knowledge_type in list(/datum/eldritch_knowledge/base_spirit, /datum/eldritch_knowledge/spell/spirit_reap, /datum/eldritch_knowledge/spirit_upgrade, /datum/eldritch_knowledge/spirit_relic))
