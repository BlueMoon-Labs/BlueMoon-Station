...
/datum/unit_test/heretic_knowledge/Run()
	...
	var/list/non_catalog_types = list(/datum/eldritch_knowledge/spell, /datum/eldritch_knowledge/spell/summon, /datum/eldritch_knowledge/curse, /datum/eldritch_knowledge/summon, /datum/eldritch_knowledge/final_eldritch, /datum/eldritch_knowledge/mansus_grasp_suspend_test, /datum/eldritch_knowledge/craft_removal_probe, /datum/eldritch_knowledge/flesh_grasp/ghost_poll_probe, /datum/eldritch_knowledge/flesh_ghoul/ghost_poll_probe, /datum/eldritch_knowledge/codex_probe, /datum/eldritch_knowledge/codex_legacy_probe, /datum/eldritch_knowledge/pocket_exit_probe, /datum/eldritch_knowledge/capture_fx_probe)
