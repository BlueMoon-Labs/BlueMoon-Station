...
/datum/unit_test/status_display_backlight_gate/Run()
	...
	display.set_machine_stat(0)
	display.update_appearance()
	TEST_ASSERT_EQUAL(display.light_range, 1.4, "Питание должно восстановить подсветку")
	...
	TEST_ASSERT_EQUAL(display.light_range, 1.4, "Новый текст должен снова включить подсветку")
	...
	TEST_ASSERT_EQUAL(display.light_power, 0.7, "Обновление должно вернуть штатную яркость")
