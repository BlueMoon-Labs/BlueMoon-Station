...
#define HERETIC_CAPTURE_MIN_IMMUNITY (10 SECONDS)
#define HERETIC_CAPTURE_IMMUNITY_PER_HOLD 6
...
#define HERETIC_POCKET_DOOR_GRIP (3 SECONDS)
#define HERETIC_POCKET_GRIP_MARGIN (0.5 SECONDS)
#define HERETIC_POCKET_ESCAPE_DISTANCE 8
...
#define HERETIC_BLADE_REFUSAL_STUN (1 SECONDS)
#define HERETIC_BLADE_REFUSAL_KNOCKDOWN (3 SECONDS)
...
#define HERETIC_MOON_SLEEPWALK_LINGER (3 SECONDS)
...
#define HERETIC_TIDE_DROWN_DRY_GRACE (1.5 SECONDS)
...
#define HERETIC_WAX_PUPPET_DOZE_TIME (3 SECONDS)
