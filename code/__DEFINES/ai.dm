...
///и поводок перестаёт существовать: те же 16 тайлов заново каждые 2 секунды.
///Урон снимает паузу немедленно (note_attacker), бой в спину не глохнет.
#define AI_PURSUIT_ABANDON_COOLDOWN (15 SECONDS)
