...
///Доля maxHealth, которую сокомандник по фракции обязан снять за окно, прежде
...
///Окно накопления дружественного урона; за его пределами счёт обнуляется
#define AI_FRIENDLY_FIRE_WINDOW (30 SECONDS)
...
///прошёл за ползущим в крите игроком 26 тайлов и всё это время стрелял.
#define AI_PURSUIT_LEASH 16
