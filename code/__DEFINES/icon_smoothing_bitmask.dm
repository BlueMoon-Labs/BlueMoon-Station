...
#define SMOOTH_GROUP_TABLES S_OBJ(51)
#define SMOOTH_GROUP_WOOD_TABLES S_OBJ(52)
#define SMOOTH_GROUP_FANCY_WOOD_TABLES S_OBJ(53)
#define SMOOTH_GROUP_BRONZE_TABLES S_OBJ(54)
#define SMOOTH_GROUP_PLASTITANIUM_TABLES S_OBJ(55)
#define SMOOTH_GROUP_GLASS_TABLES S_OBJ(56)
