...
/// восьмидесятикратный. Газовый насос на максимуме (4500) даёт 56% номинала:
...
#define PIPE_PRESSURE_RATING_STANDARD		8000
...
#define PIPE_PRESSURE_RATING_REINFORCED		80000
...
/// 8000 у неё двойной запас. Правило прежнее: штатное мапповое оборудование не
...
/// ...и до разрыва стыка. Газовый насос упирается в 0.56 номинала и не может
