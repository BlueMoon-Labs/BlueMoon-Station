...
#define LIGHTING_LAMPS_PLANE 2
#define LIGHTING_LAMPS_RENDER_TARGET "*LIGHTING_LAMPS_RENDER_TARGET"
#define LIGHTING_LAMPS_SELFGLOW 10
#define LIGHTING_EXPOSURE_PLANE 11
#define LIGHTING_LAMPS_GLARE 15
...
//-------------------- Rendering ---------------------
#define RENDER_PLANE_GAME_WORLD 16
#define RENDER_PLANE_MASTER 17
