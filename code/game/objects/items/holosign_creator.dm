...
/obj/item/holosign_creator/atmos
	...
	desc = "Проектор голографических вентиляторов. Людей пропускает, газ нет, и предохранительной муфты у него не бывает - проекция держит любой перепад давления, на котором собранный руками вентилятор распахнулся бы. Платой идёт время: эмиттер тратит заряд, пока фаны развёрнуты, и восстанавливает его, когда все сняты."
...
/obj/item/holosign_creator/combifan
	...
	desc = "Проектор голографических комбифанов. Держит и газ, и тепло, людей пропускает, муфты не имеет. Эмиттер тратит заряд, пока фаны развёрнуты, и восстанавливает его, когда все сняты."
	icon_state = "signmaker_atmos"
