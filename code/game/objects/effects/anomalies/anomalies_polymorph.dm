...
/obj/effect/anomaly/poly/detonate()
	...
	for(var/mob/living/carbon/human/H in range(detonate_range, src))
		randomize_appearance(H)
	spawn_mass_effects(detonate_range, 80, duration = 5 SECONDS)
...
/obj/effect/anomaly/poly/proc/randomize_appearance(mob/living/carbon/human/H, duration)
...
/obj/effect/anomaly/poly/proc/spawn_mass_effects(range, chance = 10, duration)
	...
	while(target > 0 && tries-- > 0)
		...
		used[T] = TRUE
		new /obj/effect/temp_visual/revenant(T, duration)
		target--
