...
/obj/effect/spawner/lootdrop/ammo/shotgun
	...
	loot = list("" = 50,
		...
		/obj/item/ammo_casing/shotgun/techshell = 4,
		/obj/item/ammo_casing/shotgun/dragonsbreath = 4,
		/obj/item/ammo_casing/shotgun/breacher = 2,
		/obj/item/ammo_box/shotgun/loaded/slug = 5,
		/obj/item/ammo_box/shotgun/loaded/pulseslug = 1,
		/obj/item/ammo_box/shotgun/loaded/laserslug = 1,
