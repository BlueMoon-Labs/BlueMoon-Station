// Hybrisa turfs - ported from CMSS13 PVE (LV759 Hybrisa Prospera)
// Adapted for CatcringeASS (TG-based)
#ifndef WALL_HUNTERSHIP
#define WALL_HUNTERSHIP "huntership"
#define WALL_KUTJEVO_ROCK "kutjevo_rock"
#define WALL_METAL "metal"
#define WALL_REINFORCED "reinforced"
#define WALL_STRATA_OUTPOST_RIBBED "strata_ribbed"
#define WALL_STRATA_OUTPOST_BARE "strata_bare"
#define HEALTH_WALL_ULTRA_REINFORCED 5000
#define HEALTH_WALL_REINFORCED 3000
#define DIRT_TYPE_SAND 1
#define NOT_WEEDABLE 0
#define CEILING_METAL 1
#define CEILING_NONE 0
#define CEILING_MAX 2
#define CEILING_UNDERGROUND_BLOCK_CAS 3
#define CEILING_UNDERGROUND_METAL_BLOCK_CAS 4
#define CEILING_REINFORCED_METAL 5
#endif

// TG compatibility: define missing turf vars
/turf
    var/allow_construction = TRUE
/turf/open
    var/supports_surgery = FALSE
/turf/closed
    var/walltype = null
/turf/open/floor
...
// Stub for auto_turf - TG doesn't have CM's blending, so define simple parent
/turf/open/auto_turf
    name = "auto turf"
