...
#define INTERACTION_REQUIRE_EARS (1<<7)
#define INTERACTION_REQUIRE_EARSOCKETS (1<<8)
#define INTERACTION_REQUIRE_EYES (1<<9)
#define INTERACTION_REQUIRE_EYESOCKETS (1<<10)
// End here
#define INTERACTION_REQUIRE_FEET (1<<11)
#define INTERACTION_REQUIRE_PENIS (1<<12)
#define INTERACTION_REQUIRE_VAGINA (1<<13)
// BLUEMOON ADD хвостики!
#define INTERACTION_REQUIRE_TAIL (1<<14)
#define INTERACTION_REQUIRE_KNOT (1<<15) // not replace INTERACTION_REQUIRE_PENIS, use both
#define INTERACTION_REQUIRE_DOUBLE_PENIS (1<<16) // not replace INTERACTION_REQUIRE_PENIS, use both
#define INTERACTION_REQUIRE_TK (1<<17)
// BLUEMOON ADD END
