 ...
 * помощника: замер стенда (D:/tmp/newbench, 2 млн созданий, четыре чередующихся прогона)
 * даёт 0.21 мкс на датум - 422 мс против 838 мс на два миллиона ГОЛЫХ датумов. В относительных
