...
/// Раунд стартует с 55-64% потолка, поэтому планка обязана стоять заметно выше старта.
#define MEMORY_EVAC_CEILING_FRACTION 0.85
...
#define MEMORY_FORCE_END_HEADROOM_MB 120
