...
/obj/item/clothing/accessory/permit/special/mage
	...
	notes = "Сотрудник имеет право применять заклинания и магические артефакты (в том числе, федерации магов) для самозащиты или своей профессиональной деятельности, в рамках КЗ (исключая статьи XX4)."
