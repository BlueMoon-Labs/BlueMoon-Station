...
/obj/item/clothing/accessory/permit/special/knifes/mail
	...
	notes = "Разрешение получено в рамках рекламной кампании с нашим партнером. Сотрудник имеет право применять холодное оружие для самозащиты или своей профессиональной деятельности, в рамках КЗ (исключая статьи XX4)."
