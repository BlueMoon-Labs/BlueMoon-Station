...
/obj/item/clothing/accessory/permit/special/knifes
	...
	notes = "Сотрудник имеет право применять холодное оружие для самозащиты или своей профессиональной деятельности, в рамках КЗ (исключая статьи XX4)."

/obj/item/clothing/accessory/permit/special/knifes/mail
	desc = "Магазин даже выбил для вас разрешение!"
	notes = "Разрешение получено в рамках рекламной компании с нашим партнером. Сотрудник имеет право применять холодное оружие для самозащиты или своей профессиональной деятельности, в рамках КЗ (исключая статьи XX4)."

/obj/item/clothing/accessory/permit/special/mage
	name = "Mage Artifacts permit"
	desc = "Зачем нужна магия, если ее использовать?"
	permitted_weapons = "Любые магические артефакты и заклинания."
	notes = "Сотрудник имеет право применять заклинания и магические артефакты для самозащиты или своей профессиональной деятельности, в рамках КЗ (исключая статьи XX4)."
