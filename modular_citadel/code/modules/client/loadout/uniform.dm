...
/datum/gear/donator/bm/sec_spo
	...
	restricted_desc = "Capitan, Nanotrasen Representative and Security"
	restricted_roles = list("Capitan", "Nanotrasen Representative", "Warden", "Detective", "Security Officer", "Head of Security")
