...
function mc_updatePingSection() {
	...
	var d = State.mcServerData;
	var pingHash = d.ping_samples + "," + d.ping_rtt_avg + "," + d.ping_rtt_max + "," + d.ping_tick_avg + "," + d.ping_server_avg + "," + d.raw_mult + "," + d.jitter_last;
...
function mc_updateKeySection() {
	...
	var keyHash = JSON.stringify(key_data);
