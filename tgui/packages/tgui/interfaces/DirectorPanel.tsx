...
const SEVERITY_ORDER = ['flavor', 'minor', 'moderate', 'major', 'antag'];
    ...
    <Stack.Item>
      <Section title="Как работает директор">
        ...
        <Box mb={1}>
          ...
          умолчанию 2), Среднее (6), Крупное (25), Антагонист (по рулсету).
          Среднее и тяжелее не стартуют мгновенно: открывается окно отмены
          (по умолчанию 15 с) с кнопками отмены и замены - и в чате
          админов, и в шапке панели.
        </Box>
        <Box mb={1}>
        ...
        <Box mb={1}>
          ...
          запусками, у тяжёлых антагов - отдельная. Ступень, отстающая от
        ...
        <Box mb={1}>
          ...
          охрана штрафует их вес. Латеджойн-антаги идут отдельным путём:
          кандидатом ставится только сам зашедший игрок.
        </Box>
        <Box>
