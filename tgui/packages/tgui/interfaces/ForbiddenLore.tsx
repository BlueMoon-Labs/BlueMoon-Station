  ...
  return (
    <>
      ...
      <Page side="right" chapter="Помощь">
        ...
        <p>На время обряда круг удерживает живую жертву и останавливает кровотечение. Перемещение жертвы или прерывание еретика срывает обряд. В Мансусе живой человек проходит испытание Дома памяти: три осколка нужно донести до печати перед вратами. Через 3 минуты Дом отпускает его сам, и он появляется в коридоре станции на глазах у окружающих.</p>
