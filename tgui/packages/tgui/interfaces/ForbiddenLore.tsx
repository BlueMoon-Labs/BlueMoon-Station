    ...
    <>
      ...
      <Page side="right" chapter="Охота">
        ...
        <ol className="HereticBook__steps">
          <li>Принесите названную цель на руну живой и без сознания. Мёртвого или бодрствующего человека Мансус не примет.</li>
          <li>Положите рядом своё живое сердце. Выберите жертвоприношение и удерживайте обряд 15 секунд.</li>
          <li>Вы получите 2 очка знаний и 1 очко для побочных знаний. Жертва пройдёт через Мансус и вернётся живой в безопасное место на станции не позднее чем через 45 секунд. Одна душа принимается лишь однажды.</li>
        </ol>
        <h3>Разломы</h3>
  ...
  return (
    <>
      ...
      <Page side="right" chapter="Помощь">
        ...
        <p>В главе «Охота» выберите цель. Призовите живое сердце: сожмите его для поиска, Alt-ЛКМ меняет цель. Принесите названного человека живым и без сознания на руну вместе со своим сердцем.</p>
        <p>Жертвоприношение длится 15 секунд и даёт 2 очка знаний и 1 очко для побочных знаний. В Мансусе человек ищет дорогу домой: выйти можно через 30 секунд, а через 45 секунд он вернётся автоматически. Повторно принести ту же душу нельзя.</p>
