  ...
  return (
    <>
      ...
      <Page side="right" chapter="Помощь">
        ...
        <h3>Отход и плен</h3>
        <p>Разбитый клинок переносит вас в случайное безопасное место; следующий побег возможен не раньше чем через 10 секунд. В наручниках и смирительной рубашке магия Мансуса и побег клинком недоступны, пока вы скованы. Имплант защиты разума глушит их, пока он в теле: вы сопротивляетесь вводу, но скованного это лишь задержит, а извлечь щит можно только хирургически. Побочное знание Разум за завесой снимает действие щита, а вознёсшегося он не держит вовсе. Станция знает об этом из предупреждения об угрозе.</p>
        <h3>Дело пути</h3>
