...
export type ForbiddenLoreData = {
  ...
  hunt: {
    ...
    pocket: { duration: number; warning: number; pull: number; tear: number; cooldown: number; hold: number };
  };
};
      ...
      <Page side="left" chapter="Помощь">
        ...
        <HelpTopic id="start" title="Начало" open={topic === 'start'}>
          <ul className="HereticBook__details">
            ...
            <li>Руну чертят кодексом на полу 3×3 без стен, космоса, лавы и соседних рун, 8 секунд.</li>
        ...
        <HelpTopic id="path" title="Путь и знания" open={topic === 'path'}>
          <ul className="HereticBook__details">
            ...
            <li>Хватка ставит метку, удар клинком её взрывает. Запас силы пути - внизу левой страницы.</li>
          </ul>
        </HelpTopic>
        ...
        <HelpTopic id="hunt" title="Охота и жертва" open={topic === 'hunt'}>
          <ul className="HereticBook__details">
            ...
            <li>Годится цель в наручниках, оглушённая, сбитая с ног или без сознания; в крите - без наручников.</li>
            <li>Добровольно лёгший или уснувший не в счёт. Еретики и их слуги не годятся, их не берёт и боевая магия.</li>
            ...
            <li>Живая: 2 очка и 1 побочное, вернётся через Мансус. Труп: 1 очко. Одна душа - один раз.</li>
          </ul>
        </HelpTopic>
        <HelpTopic id="pocket" title="Изнанка" open={topic === 'pocket'}>
          <ul className="HereticBook__details">
            <li>Изнанка - ваша карманная комната: дверь пути уводит туда цель охоты вместе с вами. Дверь пути предлагает живое сердце при касании цели, а дверь, которая работает издалека, - и при сжатии сердца, вместе с поиском цели. Внутри цель {pocket.hold} сек. не может двинуться.</li>
            <li>Общая дверь: цель повержена на вашей руне или рядом - коснитесь руны на «Помощи», «Увести за руну», {pocket.pull} сек.</li>
            ...
            <li>«Покинуть изнанку» выводит к вашим рунам, ремеслу пути или ко входу. Закрыли разрыв или вышло время - вас выносит к ближайшему своему выходу. Цель и вещи выпадают у входа.</li>
            <li>У входа остаётся разрыв: жезл или Библия закрывают его сразу, руками его рвут {pocket.tear} сек. Снова открыть - через {pocket.cooldown} сек.</li>
          </ul>
        </HelpTopic>
