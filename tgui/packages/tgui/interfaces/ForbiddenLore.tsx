  ...
  return (
    <>
      <Page side="left" chapter="Охота">
        ...
        <p className="HereticBook__annotation">Активируйте живое сердце в руке, чтобы узнать направление к цели. Alt-ЛКМ по сердцу позволяет сменить цель. Коснитесь сердцем поверженного члена экипажа, чтобы сделать целью его: подойдёт крит, наручники, оглушение или положение лёжа. Смена цели любым способом - не чаще раза в 3 минуты.</p>
      ...
      <Page side="right" chapter="Охота">
        ...
        <ol className="HereticBook__steps">
          <li>Обезвредьте названную цель. Живую цель достаточно связать наручниками, оглушить или сбить с ног. Цель в крите принимается без наручников, даже если ещё стоит. Хватка Мансуса помогает в захвате. Если назначенная цель погибла, подойдёт её труп.</li>
