    ...
    <>
      ...
      <Page side="right" chapter="Охота">
        ...
        <ol className="HereticBook__steps">
          <li>Доставьте названную цель к руне. Живую цель достаточно связать наручниками, оглушить или сбить с ног. Цель в крите принимается без наручников, даже если ещё стоит. Хватка Мансуса помогает в захвате. Если назначенная цель погибла, подойдёт её труп.</li>
