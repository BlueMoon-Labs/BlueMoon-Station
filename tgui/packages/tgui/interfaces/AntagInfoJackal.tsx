          ...
          <Stack vertical>
            ...
            <Stack.Item>
              <Section fill>
                ...
                <br />Казнь выполняется выстрелом из револьвера по критованной цели. После пяти казней на револьвер накладывается особая маска, уменьшая отдачу и увеличивая темп стрельбы.
